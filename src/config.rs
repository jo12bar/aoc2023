...
pub struct AppConfig {
    /// The location of the application's data directory.
    #[serde(default)]
    pub _data_dir: PathBuf,
    /// The location of the application's config directory.
    #[serde(default)]
...
impl Config {
    ...
    ///
    /// Creates a new config file if an existing one can't be found.
...
/// A map of actions to keybindings.
